...
public class Geogestor_mibMeta extends SnmpMibGroup
    ...
    /**
     * Permite asociar la metadata a un objeto espec�fico.
     */
    ...
    // ------------------------------------------------------------
    // 
    // Implementa el m�todo "get" definido en "SnmpMibGroup".
    ...
    // ------------------------------------------------------------
    // 
    // Implementa el m�todo "set" definido en "SnmpMibGroup".
    // Mirar la API Javadoc de "SnmpMibGroup" para obtener un mayor detalle.
    // 
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 
    // Implementa el m�todo "check" definido en "SnmpMibGroup".
    // Mirar la API Javadoc de "SnmpMibGroup" para obtener un mayor detalle.
    // 
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 
    // Implementa el m�todo "skipVariable" definido en "SnmpMibGroup".
    // Mirar la API Javadoc de "SnmpMibGroup" para obtener un mayor detalle.
    // 
    // ------------------------------------------------------------
    ...
    /**
     * M�todo de construcci�n para la meta-clase de la tabla "Tabla".
     * 
     ...
     * @param mib El objeto SnmpMib en el que la tabla est� registrada.
