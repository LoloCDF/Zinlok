...
public class TableTabla extends SnmpTableSupport implements Serializable {
    ...
    // ------------------------------------------------------------
    // 
    // Implementa el m�todo "createNewEntry" definido en "SnmpTableSupport".
    ...
    // ------------------------------------------------------------
    // 
    // Implementa el m�todo "getRegisteredTableMeta" definido en "SnmpTableSupport".
    // Mirar la API Javadoc de "SnmpTableSupport" para obtener un mayor detalle.
    // 
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 
    // Implementa el m�todo "removeEntryCb" definido en "SnmpTableSupport".
    // Mirar la API Javadoc de "SnmpTableSupport" para obtener un mayor detalle.
    // 
    // ------------------------------------------------------------
    ...
    /**
     * A�ade una nueva entrada a la tabla.
     * 
     * Si la metadata asociada necesita un ObjectName
     * un nuevo ObjectName ser� generado usando "buildNameFromIndex".
     * 
     * Este m�todo llama al m�todo "addEntry" de "SnmpTableSupport".
     * Mirar la API Javadoc de "SnmpTableSupport" para obtener un mayor detalle.
     * 
     **/
     ...
     * 
     * Este m�todo llama al m�todo "getBasicEntries" de "SnmpTableSupport".
     * Mirar la API Javadoc de "SnmpTableSupport" para obtener un mayor detalle.
     * 
     **/
     ...
     * 
     * Este m�todo llama al m�todo "removeEntry" de "SnmpTableSupport".
     * Mirar la API Javadoc de "SnmpTableSupport" para obtener un mayor detalle.
     * 
     **/
    ...
    // ------------------------------------------------------------
    // 
    // Implementa el m�todo "buildNameFromIndex" definido en "SnmpTableSupport".
    // Mirar la API Javadoc de "SnmpTableSupport" para obtener un mayor detalle.
    // 
    // ------------------------------------------------------------
    ...
    /**
     * Construyendo �ndice para "TablaEntry"
     */
    ...
    /**
     * M�todo de construcci�n para los MBeans representando a las entradas de la tabla "TablaEntry".
     * 
